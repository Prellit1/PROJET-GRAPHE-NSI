...
class Option:
    ...
    def update(self, selID, eHndl):
        ...
        Role : Renvoie une chaine de caractere correspondant à si une des
        variables dans eHndl est vrai et si selID est egal a un attribut de
        Option
...
class Menu:
    ...
    def renderSelect(self):
        """
        Role: affiche une icone sur l'ecran représentant la valeur de
        l'attribut options sélectionné
    ...
    def update(self, eHndl):
        ...
        Role: modifie l'attribut de selection en fonction d'un attribut de
        eHndl, affiche une représentation de la selection et renvoie le
        message donné par la methode handleOpt
